...
readonly BACKEND_FEATURE="webgl-backend"
...
readonly BUILD_ROOT="${PROJECT_ROOT}/target/workshop-web/webgl"
readonly WASM_INPUT="${BUILD_ROOT}/${TARGET}/release/nyon.wasm"
readonly OUTPUT_DIR="${PROJECT_ROOT}/dist/webgl"
...
# Cargo must map this package feature exclusively to wgpu's official `webgl`
# feature. Disabling defaults prevents Browser WebGPU from leaking into the
# forced-fallback qualification artifact.
...
STAGING_DIR="$(mktemp -d "${PROJECT_ROOT}/dist/.webgl-build.XXXXXX")"
