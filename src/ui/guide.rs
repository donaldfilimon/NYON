...
const TOPICS: &[(&str, &[&str])] = &[
    ...
    (
        ...
        &[
            ...
            "Undo moves to an earlier recorded creator revision. Editing history creates a branch; it does not erase later work. Select a branch to return to it. Save after choosing the branch you want to continue. Library's Export prepares a portable copy of a save, but this build cannot write that copy to a file or import one, so Save copy and the file import and export controls stay disabled.",
