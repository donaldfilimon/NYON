...
const TOPICS: &[(&str, &[&str])] = &[
    ...
    (
        ...
        &[
            "WORKSHOP: Save Workshop (Cmd/Ctrl+S) persists the current galaxy. Wait for Saved and selected for Continue, with no DIRTY marker, before quitting. Main menu / Escape requests a save; New Workshop or Classic can remain disabled while a save is pending. Continue reopens the selected Workshop save, not a Classic battle. Library, on the main menu and in the Workshop, renames and archives saves.",
